...
RejectedTravelModel rejectedTravelModelFromJson(String str) =>
    RejectedTravelModel.fromJson(json.decode(str));

class RejectedTravelModel {
  bool? status;
  List<Data>? data;

  RejectedTravelModel({this.status, this.data});

  RejectedTravelModel.fromJson(Map<String, dynamic> json) {
    status = json['Status'];
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
