...
PendingTravelModel pendingTravelModelFromJson(String str) =>
    PendingTravelModel.fromJson(json.decode(str));

class PendingTravelModel {
  bool? status;
  List<Data>? data;

  PendingTravelModel({this.status, this.data});

  PendingTravelModel.fromJson(Map<String, dynamic> json) {
    status = json['Status'];
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
